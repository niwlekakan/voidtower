...
| **Containers** | Docker list, durable start/stop/restart/remove submission, log viewer, exec shell, Compose validation/diff preview, and controlled durable Compose apply submission. |
