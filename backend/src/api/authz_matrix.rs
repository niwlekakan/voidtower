...
pub(crate) const SESSION_ROLE_MATRIX: &[(&str, &str, Role)] = &[
    ...
    ("GET", "/api/agents/:id/status", Role::Session(RoleTier::Session)),
    ("POST", "/api/agents/:id/status", Role::Session(RoleTier::Admin)),
    ...
    ("POST", "/api/ai/llama/unload", Role::Session(RoleTier::Admin)),
    ("GET", "/api/ai/providers", Role::Session(RoleTier::Admin)),
    ("POST", "/api/ai/providers", Role::Session(RoleTier::Admin)),
    ("DELETE", "/api/ai/providers/:id", Role::Session(RoleTier::Admin)),
    ("PUT", "/api/ai/providers/:id", Role::Session(RoleTier::Admin)),
    ("GET", "/api/ai/providers/:id/health", Role::Session(RoleTier::Admin)),
    ("GET", "/api/alerts", Role::Session(RoleTier::Session)),
    ("DELETE", "/api/alerts/:id", Role::SessionDenylist(RoleTier::Admin)),
    ("POST", "/api/alerts/:id/acknowledge", Role::Session(RoleTier::Session)),
    ("POST", "/api/alerts/:id/resolve", Role::Session(RoleTier::Session)),
    ("DELETE", "/api/apps/:project_name", Role::Session(RoleTier::Session)),
    ("GET", "/api/apps/:project_name/compose", Role::Session(RoleTier::Session)),
    ("POST", "/api/apps/:project_name/compose", Role::SessionDenylist(RoleTier::Operator)),
    ("POST", "/api/apps/:project_name/convert", Role::Session(RoleTier::Session)),
    ("POST", "/api/apps/:project_name/delete-volumes", Role::SessionDenylist(RoleTier::Operator)),
    ("POST", "/api/apps/:project_name/env", Role::SessionDenylist(RoleTier::Operator)),
    ("POST", "/api/apps/:project_name/expose", Role::Session(RoleTier::Admin)),
    ("GET", "/api/apps/:project_name/logs", Role::Session(RoleTier::Session)),
    ("POST", "/api/apps/:project_name/pull", Role::Session(RoleTier::Session)),
    ("POST", "/api/apps/:project_name/purge", Role::Session(RoleTier::Admin)),
    ("POST", "/api/apps/:project_name/redeploy", Role::Session(RoleTier::Session)),
    ("POST", "/api/apps/:project_name/restart", Role::Session(RoleTier::Session)),
    ("POST", "/api/apps/:project_name/start", Role::Session(RoleTier::Session)),
    ("GET", "/api/apps/:project_name/status", Role::Session(RoleTier::Session)),
    ("POST", "/api/apps/:project_name/stop", Role::Session(RoleTier::Session)),
    ...
    ("POST", "/api/apps/deploy-custom", Role::Session(RoleTier::Session)),
    ("POST", "/api/apps/deploy/cancel/:project_name", Role::Session(RoleTier::Session)),
    ("GET", "/api/apps/deployed", Role::Session(RoleTier::Session)),
    ("GET", "/api/apps/detect-env", Role::Session(RoleTier::Session)),
    ("GET", "/api/apps/detect-external", Role::Session(RoleTier::Session)),
    ("GET", "/api/apps/embed/:project_name/*path", Role::Session(RoleTier::Session)),
    ("POST", "/api/apps/open-ui", Role::Session(RoleTier::Session)),
    ("GET", "/api/audit", Role::SessionDenylist(RoleTier::Operator)),
    ...
    ("POST", "/api/auth/totp/disable", Role::Session(RoleTier::Session)),
    ("POST", "/api/auth/totp/enable", Role::Session(RoleTier::Session)),
    ("POST", "/api/auth/totp/setup", Role::Session(RoleTier::Session)),
    ("GET", "/api/automation", Role::Session(RoleTier::Session)),
    ("POST", "/api/automation", Role::SessionDenylist(RoleTier::Operator)),
    ("DELETE", "/api/automation/:id", Role::SessionDenylist(RoleTier::Operator)),
    ("PATCH", "/api/automation/:id", Role::SessionDenylist(RoleTier::Operator)),
    ("POST", "/api/automation/:id/run", Role::SessionDenylist(RoleTier::Operator)),
    ("GET", "/api/automation/:id/runs", Role::Session(RoleTier::Session)),
    ("GET", "/api/backups", Role::Session(RoleTier::Session)),
    ("POST", "/api/backups", Role::SessionDenylist(RoleTier::Operator)),
    ("DELETE", "/api/backups/:id", Role::SessionDenylist(RoleTier::Admin)),
    ("POST", "/api/backups/:id/check", Role::SessionDenylist(RoleTier::Operator)),
    ("POST", "/api/backups/:id/delete-plan", Role::SessionDenylist(RoleTier::Admin)),
    ("POST", "/api/backups/:id/restore-test", Role::SessionDenylist(RoleTier::Operator)),
    ("POST", "/api/backups/:id/run", Role::SessionDenylist(RoleTier::Operator)),
    ("GET", "/api/capabilities", Role::Public),
    ("GET", "/api/containers", Role::Session(RoleTier::Session)),
    ("POST", "/api/containers/:id/action", Role::SessionDenylist(RoleTier::Operator)),
    ("GET", "/api/containers/:id/compose", Role::Session(RoleTier::Session)),
    ("POST", "/api/containers/:id/compose/apply", Role::Session(RoleTier::Admin)),
    ("POST", "/api/containers/:id/compose/propose", Role::Session(RoleTier::Admin)),
    ("GET", "/api/containers/:id/exec", Role::SessionDenylist(RoleTier::Operator)),
    ("GET", "/api/containers/:id/logs", Role::Session(RoleTier::Session)),
    ("GET", "/api/containers/:id/logs/stream", Role::Session(RoleTier::Session)),
    ("GET", "/api/containers/images", Role::Session(RoleTier::Session)),
    ("GET", "/api/diagnostics", Role::Public),
    ("POST", "/api/disaster/emergency-disable", Role::Session(RoleTier::Owner)),
    ("POST", "/api/disaster/emergency-reset-admin", Role::Session(RoleTier::Owner)),
    ("POST", "/api/disaster/export-config", Role::Session(RoleTier::Owner)),
    ("POST", "/api/disaster/import-config", Role::Session(RoleTier::Owner)),
    ("GET", "/api/events/stream", Role::Session(RoleTier::Session)),
    ("GET", "/api/files/activity", Role::Session(RoleTier::Operator)),
    ("DELETE", "/api/files/delete", Role::Session(RoleTier::Admin)),
    ...
    ("POST", "/api/firewall/action", Role::SessionDenylist(RoleTier::Admin)),
    ("POST", "/api/firewall/rules", Role::SessionDenylist(RoleTier::Admin)),
    ("POST", "/api/firewall/rules/delete", Role::SessionDenylist(RoleTier::Admin)),
    ("GET", "/api/health", Role::Public),
    ("GET", "/api/integrations/actions", Role::Session(RoleTier::Admin)),
    ("GET", "/api/integrations/events", Role::Session(RoleTier::Session)),
    ("GET", "/api/integrations/odysseus/config", Role::Session(RoleTier::Admin)),
    ("POST", "/api/integrations/odysseus/config", Role::Session(RoleTier::Admin)),
    ("GET", "/api/integrations/odysseus/manifest", Role::Public),
    ("GET", "/api/integrations/odysseus/theme", Role::Session(RoleTier::Admin)),
    ("GET", "/api/integrations/scopes", Role::Public),
    ("GET", "/api/integrations/tokens", Role::Session(RoleTier::Admin)),
    ("POST", "/api/integrations/tokens", Role::Session(RoleTier::Admin)),
    ("DELETE", "/api/integrations/tokens/:id", Role::Session(RoleTier::Admin)),
    ("POST", "/api/integrations/webhooks", Role::NonSessionCredential),
    ("GET", "/api/lxc", Role::Session(RoleTier::Admin)),
    ("POST", "/api/lxc/:vmid/action", Role::Session(RoleTier::Admin)),
    ("GET", "/api/lxc/:vmid/config", Role::Session(RoleTier::Admin)),
    ...
    ("GET", "/api/members/:user_id/access", Role::Session(RoleTier::Admin)),
    ("POST", "/api/members/:user_id/access", Role::Session(RoleTier::Admin)),
    ("DELETE", "/api/members/:user_id/access/:app_id", Role::Session(RoleTier::Admin)),
    ("POST", "/api/members/:user_id/custom-deploy", Role::Session(RoleTier::Admin)),
    ("POST", "/api/members/:user_id/drives", Role::Session(RoleTier::Admin)),
    ("POST", "/api/members/:user_id/storage", Role::Session(RoleTier::Admin)),
    ("DELETE", "/api/members/drives/:drive_id", Role::Session(RoleTier::Admin)),
    ("GET", "/api/members/me/access", Role::Session(RoleTier::Session)),
    ("GET", "/api/members/me/nodes", Role::Session(RoleTier::Session)),
    ("GET", "/api/metrics/current", Role::Session(RoleTier::Session)),
    ("GET", "/api/metrics/ws", Role::Session(RoleTier::Session)),
    ("GET", "/api/models", Role::Session(RoleTier::Admin)),
    ("DELETE", "/api/models/:filename", Role::Session(RoleTier::Admin)),
    ("GET", "/api/models/active", Role::Session(RoleTier::Admin)),
    ("POST", "/api/models/download", Role::Session(RoleTier::Admin)),
    ("GET", "/api/models/download/:id", Role::Public),
    ("GET", "/api/models/llama-config", Role::Session(RoleTier::Admin)),
    ("POST", "/api/models/llama-config", Role::Session(RoleTier::Admin)),
    ("POST", "/api/models/load", Role::Session(RoleTier::Admin)),
    ("GET", "/api/models/ollama", Role::Session(RoleTier::Admin)),
    ("GET", "/api/models/ollama-config", Role::Session(RoleTier::Admin)),
    ("POST", "/api/models/ollama-config", Role::Session(RoleTier::Admin)),
    ("POST", "/api/models/ollama/create", Role::Session(RoleTier::Admin)),
    ("GET", "/api/models/ollama/create/:id", Role::Public),
    ("POST", "/api/models/ollama/pull", Role::Session(RoleTier::Admin)),
    ...
    ("DELETE", "/api/nav-config", Role::Session(RoleTier::Session)),
    ("GET", "/api/nav-config", Role::Session(RoleTier::Session)),
    ("POST", "/api/nav-config", Role::Session(RoleTier::Session)),
    ("DELETE", "/api/nav-config/default", Role::Session(RoleTier::Owner)),
    ("GET", "/api/nav-config/default", Role::Session(RoleTier::Session)),
    ("POST", "/api/nav-config/default", Role::Session(RoleTier::Owner)),
    ("GET", "/api/network/neighbors", Role::Session(RoleTier::Session)),
    ("GET", "/api/nodes", Role::Session(RoleTier::Admin)),
    ("DELETE", "/api/nodes/:id", Role::Session(RoleTier::Admin)),
    ("POST", "/api/nodes/:id/heartbeat", Role::NonSessionCredential),
    ("POST", "/api/nodes/enroll", Role::NonSessionCredential),
    ("POST", "/api/nodes/pairing-code", Role::Session(RoleTier::Admin)),
    ...
    ("DELETE", "/api/policy/rules/:id", Role::Session(RoleTier::Admin)),
    ("PATCH", "/api/policy/rules/:id", Role::Session(RoleTier::Admin)),
    ("GET", "/api/proxmox/:host_id/backup-jobs", Role::Session(RoleTier::Admin)),
    ("POST", "/api/proxmox/:host_id/lxc/deploy", Role::Session(RoleTier::Admin)),
    ("GET", "/api/proxmox/:host_id/nodes", Role::Session(RoleTier::Admin)),
    ("GET", "/api/proxmox/:host_id/nodes/:node/disks", Role::Session(RoleTier::Admin)),
    ("POST", "/api/proxmox/:host_id/nodes/:node/disks/init", Role::Session(RoleTier::Admin)),
    ("GET", "/api/proxmox/:host_id/nodes/:node/disks/smart", Role::Session(RoleTier::Admin)),
    ("POST", "/api/proxmox/:host_id/nodes/:node/disks/wipe", Role::Session(RoleTier::Admin)),
    ("DELETE", "/api/proxmox/:host_id/nodes/:node/storage/:storage/content", Role::Session(RoleTier::Admin)),
    ("GET", "/api/proxmox/:host_id/nodes/:node/storage/:storage/content", Role::Session(RoleTier::Admin)),
    ("POST", "/api/proxmox/:host_id/nodes/:node/storage/:storage/content", Role::Session(RoleTier::Admin)),
    ("GET", "/api/proxmox/:host_id/storage", Role::Session(RoleTier::Admin)),
    ("GET", "/api/proxmox/:host_id/tasks", Role::Session(RoleTier::Admin)),
    ("GET", "/api/proxmox/:host_id/vms", Role::Session(RoleTier::Admin)),
    ("POST", "/api/proxmox/:host_id/vms/:vmid/disk-passthrough", Role::Session(RoleTier::Admin)),
    ("POST", "/api/proxmox/:host_id/vms/:vmid/reboot", Role::Session(RoleTier::Admin)),
    ("POST", "/api/proxmox/:host_id/vms/:vmid/reset", Role::Session(RoleTier::Admin)),
    ("POST", "/api/proxmox/:host_id/vms/:vmid/resume", Role::Session(RoleTier::Admin)),
    ("POST", "/api/proxmox/:host_id/vms/:vmid/rollback/:snapname", Role::Session(RoleTier::Admin)),
    ("POST", "/api/proxmox/:host_id/vms/:vmid/shutdown", Role::Session(RoleTier::Admin)),
    ("POST", "/api/proxmox/:host_id/vms/:vmid/snapshot", Role::Session(RoleTier::Admin)),
    ("DELETE", "/api/proxmox/:host_id/vms/:vmid/snapshot/:snapname", Role::Session(RoleTier::Admin)),
    ("GET", "/api/proxmox/:host_id/vms/:vmid/snapshots", Role::Session(RoleTier::Admin)),
    ("POST", "/api/proxmox/:host_id/vms/:vmid/start", Role::Session(RoleTier::Admin)),
    ("POST", "/api/proxmox/:host_id/vms/:vmid/stop", Role::Session(RoleTier::Admin)),
    ("POST", "/api/proxmox/:host_id/vms/:vmid/suspend", Role::Session(RoleTier::Admin)),
    ("POST", "/api/proxmox/:host_id/vms/:vmid/vncproxy", Role::Session(RoleTier::Admin)),
    ("GET", "/api/proxmox/hosts", Role::Session(RoleTier::Admin)),
    ("POST", "/api/proxmox/hosts", Role::Session(RoleTier::Admin)),
    ("DELETE", "/api/proxmox/hosts/:host_id", Role::Session(RoleTier::Admin)),
    ...
    ("GET", "/api/proxy/:id/health", Role::Session(RoleTier::Admin)),
    ("POST", "/api/proxy/:id/toggle", Role::Session(RoleTier::Admin)),
    ("POST", "/api/proxy/ai-auto", Role::Session(RoleTier::Admin)),
    ("GET", "/api/proxy/nginx-setup", Role::Session(RoleTier::Admin)),
    ("POST", "/api/proxy/nginx/action", Role::Session(RoleTier::Admin)),
    ("GET", "/api/proxy/nginx/logs", Role::Session(RoleTier::Admin)),
    ("GET", "/api/proxy/nginx/status", Role::Session(RoleTier::Admin)),
    ...
    ("GET", "/api/secrets/:id/reveal", Role::Session(RoleTier::Admin)),
    ("POST", "/api/secrets/:id/rotate", Role::Session(RoleTier::Admin)),
    ("GET", "/api/security/sessions", Role::Session(RoleTier::Session)),
    ("DELETE", "/api/security/sessions/:id", Role::Session(RoleTier::Session)),
    ("POST", "/api/security/sessions/revoke-others", Role::Session(RoleTier::Session)),
    ("GET", "/api/services", Role::Session(RoleTier::Session)),
    ("GET", "/api/services/:name", Role::Session(RoleTier::Session)),
    ("POST", "/api/services/:name/action", Role::SessionDenylist(RoleTier::Operator)),
    ("GET", "/api/services/:name/logs", Role::Session(RoleTier::Session)),
    ("GET", "/api/settings/ai-url", Role::Session(RoleTier::Admin)),
    ("POST", "/api/settings/ai-url", Role::Session(RoleTier::Admin)),
    ("GET", "/api/settings/general", Role::Session(RoleTier::Admin)),
    ("POST", "/api/settings/general", Role::Session(RoleTier::Admin)),
    ("GET", "/api/settings/mfa-policy", Role::Session(RoleTier::Admin)),
    ("POST", "/api/settings/mfa-policy", Role::Session(RoleTier::Admin)),
    ("GET", "/api/settings/notifications", Role::Session(RoleTier::Admin)),
    ("POST", "/api/settings/notifications", Role::Session(RoleTier::Admin)),
    ("POST", "/api/settings/notifications/test", Role::Session(RoleTier::Admin)),
    ("GET", "/api/settings/public", Role::Public),
    ("GET", "/api/status-checks", Role::Session(RoleTier::Session)),
    ("POST", "/api/status-checks", Role::SessionDenylist(RoleTier::Operator)),
    ("DELETE", "/api/status-checks/:id", Role::SessionDenylist(RoleTier::Admin)),
    ("GET", "/api/storage/devices", Role::Session(RoleTier::Admin)),
    ("POST", "/api/storage/format", Role::Session(RoleTier::Admin)),
    ("GET", "/api/storage/fstab", Role::Session(RoleTier::Admin)),
    ("POST", "/api/storage/fstab", Role::Session(RoleTier::Admin)),
    ("DELETE", "/api/storage/fstab/:idx", Role::Session(RoleTier::Admin)),
    ...
    ("POST", "/api/storage/raid/create", Role::Session(RoleTier::Admin)),
    ("POST", "/api/storage/raid/stop", Role::Session(RoleTier::Admin)),
    ("GET", "/api/storage/smart/:dev", Role::Session(RoleTier::Admin)),
    ("POST", "/api/storage/umount", Role::Session(RoleTier::Admin)),
    ("GET", "/api/studio/audio/:filename", Role::Session(RoleTier::Session)),
    ("GET", "/api/studio/gallery", Role::Session(RoleTier::Session)),
    ("DELETE", "/api/studio/gallery/:kind/:filename", Role::Session(RoleTier::Session)),
    ("POST", "/api/studio/image/generate", Role::Session(RoleTier::Session)),
    ("GET", "/api/studio/images/:filename", Role::Session(RoleTier::Session)),
    ("POST", "/api/studio/mcp/invoke", Role::Session(RoleTier::Session)),
    ("GET", "/api/studio/mcp/tools", Role::Session(RoleTier::Session)),
    ("GET", "/api/studio/status", Role::Session(RoleTier::Session)),
    ("POST", "/api/studio/stt/transcribe", Role::Session(RoleTier::Session)),
    ("POST", "/api/studio/tts/generate", Role::Session(RoleTier::Session)),
    ("POST", "/api/system/restart", Role::Session(RoleTier::Admin)),
    ("POST", "/api/system/update", Role::Session(RoleTier::Admin)),
    ("GET", "/api/system/update-check", Role::Session(RoleTier::Admin)),
    ...
    ("GET", "/api/terminal/local/sessions", Role::SessionDenylist(RoleTier::Operator)),
    ("POST", "/api/terminal/local/sessions", Role::SessionDenylist(RoleTier::Operator)),
    ("DELETE", "/api/terminal/local/sessions/:id", Role::SessionDenylist(RoleTier::Operator)),
    ("PUT", "/api/terminal/local/sessions/:id", Role::SessionDenylist(RoleTier::Operator)),
    ("GET", "/api/terminal/ssh/sessions", Role::SessionDenylist(RoleTier::Operator)),
    ("POST", "/api/terminal/ssh/sessions", Role::SessionDenylist(RoleTier::Operator)),
    ("DELETE", "/api/terminal/ssh/sessions/:id", Role::SessionDenylist(RoleTier::Operator)),
    ("PUT", "/api/terminal/ssh/sessions/:id", Role::SessionDenylist(RoleTier::Operator)),
    ("GET", "/api/terminal/ssh/ws", Role::SessionDenylist(RoleTier::Operator)),
    ("GET", "/api/terminal/ws", Role::SessionDenylist(RoleTier::Operator)),
    ("GET", "/api/timeline", Role::SessionDenylist(RoleTier::Operator)),
    ("GET", "/api/updates/docker", Role::Session(RoleTier::Admin)),
    ("POST", "/api/updates/docker/:id/apply", Role::Session(RoleTier::Admin)),
    ("POST", "/api/updates/docker/check", Role::Session(RoleTier::Admin)),
    ("GET", "/api/updates/odysseus", Role::Session(RoleTier::Admin)),
    ("POST", "/api/updates/odysseus/apply", Role::Session(RoleTier::Admin)),
    ("GET", "/api/updates/os", Role::Session(RoleTier::Admin)),
    ("POST", "/api/updates/os/apply", Role::Session(RoleTier::Admin)),
    ("GET", "/api/updates/voidtower", Role::Session(RoleTier::Admin)),
    ("POST", "/api/updates/voidtower/apply", Role::Session(RoleTier::Admin)),
    ("POST", "/api/updates/voidtower/check", Role::Session(RoleTier::Admin)),
    ("POST", "/api/updates/voidtower/rollback", Role::Session(RoleTier::Admin)),
    ...
    ("POST", "/api/users/me/password", Role::Session(RoleTier::Session)),
    ("GET", "/api/vms/local", Role::Session(RoleTier::Admin)),
    ("POST", "/api/vms/local/action", Role::Session(RoleTier::Admin)),
    ("POST", "/api/vms/proxmox/action", Role::Session(RoleTier::Admin)),
    ("GET", "/api/vms/proxmox/config", Role::Session(RoleTier::Admin)),
    ("POST", "/api/vms/proxmox/config", Role::Session(RoleTier::Admin)),
    ("POST", "/api/vms/proxmox/test", Role::Session(RoleTier::Admin)),
    ("GET", "/api/vms/proxmox/vms", Role::Session(RoleTier::Admin)),
    ("GET", "/api/webhooks", Role::Session(RoleTier::Admin)),
    ("POST", "/api/webhooks", Role::Session(RoleTier::Admin)),
    ("DELETE", "/api/webhooks/:id", Role::Session(RoleTier::Admin)),
    ("PATCH", "/api/webhooks/:id", Role::Session(RoleTier::Admin)),
    ("POST", "/api/webhooks/:id/test", Role::Session(RoleTier::Admin)),
    ("GET", "/api/wireguard", Role::Session(RoleTier::Admin)),
    ("POST", "/api/wireguard/peers", Role::Session(RoleTier::Admin)),
    ("DELETE", "/api/wireguard/peers/:id", Role::Session(RoleTier::Admin)),
    ("GET", "/plugin-assets/:id/*path", Role::Session(RoleTier::Session)),
